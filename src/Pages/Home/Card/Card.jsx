  ...
  return (
    ...
    <div>
      <div className="w-full max-w-sm overflow-hidden h-[400px] bg-white rounded-lg shadow-lg dark:bg-gray-800">
        <img
          className="object-cover object-center w-full p-3 rounded-xl h-56"
          src={item?.image}
          alt="avatar"
        />

        <div className="px-6 py-4">
          <h1 className="text-xl font-semibold font-jost text-gray-800 dark:text-white">
            {item?.name}
          </h1>

          <p className="py-2 text-gray-700 font-popins8 dark:text-gray-400">
            {item?.description}
          </p>
        </div>
      </div>
